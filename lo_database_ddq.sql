...
INSERT INTO `lo_customers` (`customer_id`, `customer_email`, `customer_firstname`, `customer_lastname`) VALUES
...
INSERT INTO `lo_genders` (`gender_id`, `gender_description`) VALUES
(`M`, `Male`),
(`F`, `Female`),
(`U`, `Unisex`);
...
INSERT INTO `lo_activities` (`activity_id`, `activity_description`) VALUES
(1, `Running`),
(2, `Swimming`),
(3, `Biking`);
...
INSERT INTO `lo_products` (`product_id`, `product_name`, `product_description`
                            `gender_id`, `activity_id`, `product_price`) VALUES
(1, `Leggings`, `Running tights made of Nylux.`, `F`, `Running`, 98),
(2, `Vent Tech 2.0 Shirt`, `Tech running shirt made of Nylux.`, `M`, `Running`, 68),
(3, `Cycle Shirt`, `Tech cycling shirt made of Nylux.`, `F`, `Cycling`, 88);
...
INSERT INTO `lo_stores` (`store_id`, `store_email`, `store_phone`, `store_street`,
                        `store_city`, `store_state`, `store_country`, `store_zip`) VALUES
